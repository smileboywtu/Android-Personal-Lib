package com.smileboy.roundbutton;

import com.example.roundbutton.R;
...
public class CircleButton extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText(text, (centerX - text.length() * textSize / 4), (centerY + textSize / 4), textPaint);
		super.onDraw(canvas);
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		Typeface currentType = textPaint.getTypeface();
		Typeface bold = Typeface.create(currentType, Typeface.BOLD);
